...
ln -s ~/dataindependence.net/dist/public ./what-can.be/dist/public/dataindependence
ln -s ~/beyond-decentralized.world/dist/public ./what-can.be/dist/public/beyond-decentralized
ln -s ~/turbase.org/dist/public ./what-can.be/dist/public/turbase
ln -s ~/notes ~/may-there-always-be-sunshine.space/dist/public/notes